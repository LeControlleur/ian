...
function getHTMLMediaElement(mediaElement, config) {
    ...
    function adjustControls() {
        ...
        if (slider) {
            ...
            volumeControl.style.marginLeft = "3%";
            //volumeControl.style.marginLeft = (mediaElementContainer.clientWidth - volumeControl.clientWidth - 2) + 'px';
        }

        volumeControl.style.marginTop = "3%";
        //volumeControl.style.marginTop = (mediaElementContainer.clientHeight - volumeControl.clientHeight - 2) + ' 10 px';
